...
st.set_page_config(page_title="Gadgets Chatbot", layout="wide")
...
csv_file = "product_reviews_electronics.csv"
...
def main():
    ...
    user_question = st.text_input("Ask a Question (e.g., 'What is the review of Dell XPS 13?')", key="user_question")
